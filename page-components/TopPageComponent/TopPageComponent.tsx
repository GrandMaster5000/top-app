...
import { Advanteges, HhData, Htag, Product, Sort, Tag } from '../../components';
    ...
    return(
        <div className={styles.wrapper}>
            <div className={styles.title}>
                ...
                {products && <Tag color='gray' size='big' aria-label={products.length + 'элементов'}>{products.length}</Tag>}
            ...
            {page.seoText != '' && page.seoText !== undefined && <div className={styles.seo} dangerouslySetInnerHTML={{__html: page.seoText}}/>}
